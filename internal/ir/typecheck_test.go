...
func TestBytecodeTypecheck_OperandTypes(t *testing.T) {
	...
	testCases := []struct {
		...
		{"add_portion left", BinaryOp{Op: OpAddPortion{}, Dest: 9, Left: intReg, Right: portionReg}},
		{"add_portion right", BinaryOp{Op: OpAddPortion{}, Dest: 9, Left: portionReg, Right: intReg}},
		...
		{"int_to_portion arg", UnaryOp{Op: OpIntToPortion{}, Dest: 9, Arg: portionReg}},
		{"portion_to_int arg", UnaryOp{Op: OpPortionToInt{}, Dest: 9, Arg: intReg}},
