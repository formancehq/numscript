...
func irParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		3, 10, 108, 8, 10, 1, 11, 1, 11, 1, 11, 1, 11, 1, 11, 1, 11, 1, 11, 1,
		11, 3, 11, 118, 8, 11, 1, 12, 1, 12, 3, 12, 122, 8, 12, 1, 13, 1, 13, 1,
		...
		1, 0, 0, 0, 20, 107, 1, 0, 0, 0, 22, 117, 1, 0, 0, 0, 24, 121, 1, 0, 0,
		...
		0, 0, 109, 118, 3, 26, 13, 0, 110, 118, 5, 7, 0, 0, 111, 118, 5, 8, 0,
		0, 112, 118, 5, 5, 0, 0, 113, 114, 5, 13, 0, 0, 114, 115, 3, 10, 5, 0,
		115, 116, 5, 14, 0, 0, 116, 118, 1, 0, 0, 0, 117, 109, 1, 0, 0, 0, 117,
		110, 1, 0, 0, 0, 117, 111, 1, 0, 0, 0, 117, 112, 1, 0, 0, 0, 117, 113,
		1, 0, 0, 0, 118, 23, 1, 0, 0, 0, 119, 122, 5, 9, 0, 0, 120, 122, 5, 8,
		0, 0, 121, 119, 1, 0, 0, 0, 121, 120, 1, 0, 0, 0, 122, 25, 1, 0, 0, 0,
		123, 124, 5, 6, 0, 0, 124, 27, 1, 0, 0, 0, 11, 31, 38, 61, 69, 76, 89,
		98, 101, 107, 117, 121,
	}
...
func (p *IRParser) Args() (localctx IArgsContext) {
	...
	if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&9696) != 0 {
		{
			p.SetState(93)
			p.Arg()
		}
...
func (p *IRParser) Arg() (localctx IArgContext) {
	...
	switch p.GetTokenStream().LA(1) {
	case IRParserBOOL, IRParserREG, IRParserLABEL, IRParserINT, IRParserLBRACKET:
...
func (s *ValBoolContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(IRListener); ok {
		listenerT.EnterValBool(s)
	}
}

func (s *ValBoolContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(IRListener); ok {
		listenerT.ExitValBool(s)
	}
}
