...
//
// It is the compiler's checker. The analysis module (LSP/CI) keeps its own
// unification-based checker: asset-identity inference, feature-version gating
// and lint-style warnings all stay there, and it does not consume this package.
package typecheck
